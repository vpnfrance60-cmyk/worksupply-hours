...
export function GlowingShadow({ children, hue = 195, width = "35vw" }: GlowingShadowButtonProps) {
  return (
    <>
      <style jsx>{`
        @property --hue {
        ...
        .glow-content:before {
          ...
          background: hsl(0deg 0% 16%) radial-gradient(
            ...
            hsl(calc(var(--base-hue) + var(--hue) * var(--hue-speed) * 1deg) 100% 90%) calc(0% * var(--bg-size)),
            hsl(calc(var(--base-hue) + var(--hue) * var(--hue-speed) * 1deg) 100% 80%) calc(20% * var(--bg-size)),
            hsl(calc(var(--base-hue) + var(--hue) * var(--hue-speed) * 1deg) 100% 60%) calc(40% * var(--bg-size)),
            transparent 100%
          );
        ...
        .glow:after {
          ...
          left: -15%;
          top: -15%;
          background: hsl(calc(var(--base-hue) + var(--hue) * var(--hue-speed) * 1deg) 100% 60%);
          position: relative;
          border-radius: calc(var(--glow-radius) * 10vw);
          animation: hue-animation var(--animation-speed) linear infinite;
      ...
      <div
        ...
        style={{ "--base-hue": `${hue}deg`, "--card-width": width } as CSSProperties}
      >
